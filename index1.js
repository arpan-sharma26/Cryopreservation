...
BtnTwo.addEventListener('click',() => {
    res = "You selected 'Temperature involved'.";
...
BtnThree.addEventListener('click',() => {
    res = "You selected 'Human specimens undergoing process'.";
    localStorage.setItem('valuePrint',res);
...
BtnFour.addEventListener('click',() => {
    res = "You selected 'Making it cost efficient'.";
    localStorage.setItem('valuePrint',res);
...
BtnFive.addEventListener('click',() => {
    res = "You selected'Maintenance of the Frozen human body'.";
    localStorage.setItem('valuePrint',res);
